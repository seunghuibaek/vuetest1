...
백엔드 서버 개발 및 운영(Back-End Developer)

API 서버 운영 및 신규 서비스 개발 담당

✅ 직무 목표

안정적인 API 서버 운영을 통해 서비스 가용성과 성능을 보장

발생 가능한 프로그램 오류를 신속히 해결하여 서비스 품질 유지

신규 기능 및 서비스 개발을 통해 사용자 경험 개선과 사업 성장 기여

✅ 직무 내용

API 서버 관리

서버 환경 설정, 배포 및 모니터링 수행
...
서비스 운영 중 발생하는 오류 분석 및 해결

버그 리포트 기반 문제 원인 파악 및 코드 수정

QA 및 테스트 프로세스를 통한 품질 보증

신규 서비스 개발

요구사항 분석 및 시스템 설계 참여

신규 기능 구현 및 API 설계/개발

데이터베이스 모델링 및 연동

협업을 통한 서비스 배포 및 유지보수
---------------------------
