...
API 서버 운영 및 서비스 개발 담당자

2. 직무 목표

API 서버의 안정적 운영 및 성능 최적화를 통해 서비스 품질을 보장한다.

발생하는 프로그램 오류를 신속·정확하게 해결하여 시스템 가용성을 유지한다.

신규 서비스 및 기능 개발을 통해 회사의 경쟁력 강화와 비즈니스 성장에 기여한다.

3. 직무 내용

API 서버 관리

서버 환경 구축, 운영 및 성능 모니터링

보안 관리 및 로그 분석을 통한 장애 예방

서버 성능 최적화 및 장애 발생 시 신속 대응

프로그램 오류 수정

서비스 운영 중 발생하는 오류 및 버그 분석

문제 원인 진단 및 코드 수정, 개선 사항 반영

QA 및 테스트를 통한 품질 검증 및 안정성 확보
